...
if (array_get(tileTargetsTicksBeforeHit,1) == 0) {
	instance_create_layer(416,480,"floor_lightnings",obj_lightning_shadow0);
}
if (array_get(tileTargetsTicksBeforeHit,2) == 0) {
	instance_create_layer(480,480,"floor_lightnings",obj_lightning_shadow0);
}
if (array_get(tileTargetsTicksBeforeHit,3) == 0) {
	instance_create_layer(544,480,"floor_lightnings",obj_lightning_shadow0);
}
if (array_get(tileTargetsTicksBeforeHit,4) == 0) {
	instance_create_layer(608,480,"floor_lightnings",obj_lightning_shadow0);
}
if (array_get(tileTargetsTicksBeforeHit,5) == 0) {
	instance_create_layer(672,480,"floor_lightnings",obj_lightning_shadow0);
}
if (array_get(tileTargetsTicksBeforeHit,6) == 0) {
	instance_create_layer(736,480,"floor_lightnings",obj_lightning_shadow0);
}
if (array_get(tileTargetsTicksBeforeHit,7) == 0) {
	instance_create_layer(800,480,"floor_lightnings",obj_lightning_shadow0);
}
if (array_get(tileTargetsTicksBeforeHit,8) == 0) {
	instance_create_layer(864,480,"floor_lightnings",obj_lightning_shadow0);
}
